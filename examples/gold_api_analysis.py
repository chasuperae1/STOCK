...
class GoldAnalyzer:
    ...
    def fetch_real_time_price(self):
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                print(f"✅ gold-api.com 成功: ${d['price']:.2f}/oz")
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                print(f"✅ xaus.com 成功: ${d['spot_usd_oz']:.2f}/oz")
        except Exception as e:
            print(f"⚠️ xaus.com错误: {e}")
        
        # 备用API: aurumrates.com
        try:
            ...
            if resp.status_code == 200:
                ...
                if d.get('status') == 'ok':
                    ...
                    print(f"✅ aurumrates成功: ${gold['price']:.2f}/oz ({gold['change_pct']:+.2f}%)")
        except Exception as e:
    ...
    def analyze_game_theory(self):
        ...
        analysis['herding_desc'] = '新闻数据有限，暂无法判断羊群效应'
    ...
    def get_comprehensive_score(self):
        ...
        total_score = (
            ...
            self.analyze_game_theory()['total_score'] * weights['game_theory']
        )
...
def main():
    ...
    if 'gold_api' in data:
        d = data['gold_api']
        print(f"\n💰 gold-api.com:")
        print(f"   价格: ${d['price']:.2f}/oz")
        print(f"   更新: {d['updated_readable']} ({d['updated_at']})")
